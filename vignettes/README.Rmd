...
plot(seq(0, max(surv[,1]), 0.01)[seq(0, max(surv[,1]), 0.01)<=t_up],
     mpl_h0Ti_tau0[seq(0, max(surv[,1]), 0.01)<=t_up],
     type="l", col="black", lty=1, lwd=1, cex.axis=1, cex.lab=1, ylim=c(0, y_uplim),
     xlab='Time (Month)', ylab='Hazard')
par(new=TRUE)
plot(seq(0, max(surv[,1]), 0.01)[seq(0, max(surv[,1]), 0.01)<=t_up],
     mpl_h0Ti_tau0.2[seq(0, max(surv[,1]), 0.01)<=t_up],
     type="l", col="grey", lty=2, lwd=1, cex.axis=1, cex.lab=1, ylim=c(0, y_uplim),
     xlab='Time (Month)', ylab='Hazard')
par(new=TRUE)
plot(seq(0, max(surv[,1]), 0.01)[seq(0, max(surv[,1]), 0.01)<=t_up],
     mpl_h0Ti_tau0.5[seq(0, max(surv[,1]), 0.01)<=t_up],
     type="l", col="green", lty=3, lwd=1, cex.axis=1, cex.lab=1, ylim=c(0, y_uplim),
     xlab='Time (Month)', ylab='Hazard')
par(new=TRUE)
plot(seq(0, max(surv[,1]), 0.01)[seq(0, max(surv[,1]), 0.01)<=t_up],
     mpl_h0Ti_tau0.8[seq(0, max(surv[,1]), 0.01)<=t_up],
     type="l", col="blue", lty=4, lwd=1, cex.axis=1, cex.lab=1, ylim=c(0, y_uplim),
     xlab='Time (Month)', ylab='Hazard')
par(new=TRUE)
...
plot(ta, c(MPL_beta_tau0[j,1],
           ...
           MPL_beta_tau0.5[j,1],
           MPL_beta_tau0.8[j,1]
          ), type="p", pch=19, cex=1, cex.axis=1, cex.lab=1, 
     xlim=c(-0.1, 0.9), ylim=c( min(MPL_beta_tau0[j,1] - 1.96*MPL_beta_tau0[j,2],
                                    MPL_beta_tau0.2[j,1] - 1.96*MPL_beta_tau0.2[j,2],
                                    MPL_beta_tau0.5[j,1] - 1.96*MPL_beta_tau0.5[j,2],
                                    MPL_beta_tau0.8[j,1] - 1.96*MPL_beta_tau0.8[j,2]
     ...
     xlab='Tau', ylab='Estimate and 95% CI')
par(new=TRUE)
plot(ta, c(MPL_beta_tau0[j,1] - 1.96*MPL_beta_tau0[j,2],
           MPL_beta_tau0.2[j,1] - 1.96*MPL_beta_tau0.2[j,2],
           MPL_beta_tau0.5[j,1] - 1.96*MPL_beta_tau0.5[j,2],
           MPL_beta_tau0.8[j,1] - 1.96*MPL_beta_tau0.8[j,2]
          ), 
     type="p", pch=4, cex=1, cex.axis=1, cex.lab=1, 
     xlim=c(-0.1, 0.9), ylim=c(min(MPL_beta_tau0[j,1] - 1.96*MPL_beta_tau0[j,2],
                                   MPL_beta_tau0.2[j,1] - 1.96*MPL_beta_tau0.2[j,2],
                                   MPL_beta_tau0.5[j,1] - 1.96*MPL_beta_tau0.5[j,2],
                                   MPL_beta_tau0.8[j,1] - 1.96*MPL_beta_tau0.8[j,2]
